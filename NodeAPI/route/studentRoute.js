...
studentRouter.post("/api/signinup",(req, res)=>{
    let studentData = req.body; //this will be the user object inserted by end user at fron end
    console.log(studentData)
    studentDataModel.findOne({userName:req.body.userName}).then((existingStudent)=>{
